...
- > _Note: This efficient flow requires updating the `/api/register/` endpoint specified in `backend-guide.md` to return tokens upon successful registration. This is a modern and recommended approach._
