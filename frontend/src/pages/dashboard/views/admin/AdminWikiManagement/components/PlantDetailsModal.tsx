...
const DetailItem = ({
  ...
  <FormControl fullWidth sx={{ mb: 2 }}>
    <FormLabel sx={{ fontSize: '0.75rem', color: 'text.secondary', mb: 1 }}>
      {label}
    </FormLabel>
    <Typography variant="body1" component="div" sx={{ minHeight: '1.5rem' }}>
      {value || "N/A"}
    </Typography>
...
export default function PlantDetailsModal({
  ...
  const activeUseFlags = useFlags.filter(flag => plant.uses[flag.id]);
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle>Plant Details: {plant.scientific_name}</DialogTitle>
      <DialogContent>
